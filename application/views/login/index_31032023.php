...
<div class="login-box">
  <a href="" class="logo d-flex align-items-center">
        ...
        <center><img width="350px" height="200px" src="<?php echo base_url(); ?>imagenes/<?php echo $logo; ?>"   > </center>
  ...
  <div class="login-box-body">
    ...
    <?php 
      ...
      ?>
    <form  id="frm_save" action="<?php echo base_url(); ?>login/ingresar" method="POST">
      ...
      <div class="row">
        <div class="col-md-12">
          <!-- <button type="submit" onclick="resolucion()" class="btn btn-primary btn-block btn-flat">Ingresar</button> -->

          <button type="button"   onclick="resolucion()" class="btn btn-primary btn-block btn-flat">Ingresar</button>
        </div>
        <!-- /.col -->
      </div>
      <input type="hidden"  name="we" id='we'>
      <input type="hidden"  name="he" id='he'>
    </form>
    <br>
    <div class="row">
        <div class="col-md-12">
...
<script>
  ...
  //       Swal.fire({
  //       title: '<strong style="font-size:30px" >Aviso</strong>',
  //       icon: 'warning',
  //       html:
  //       '<p style="font-size:20px"> Estimado Cliente , </p>   ' +
  //       ' <p style="font-size:20px"> Es un gusto trabajar para ustedes y solo con su ayuda podemos lograrlo! </p> '+
  //       ' <p style="font-size:20px"> En este momento tiene <b style="font-size:20px">documentos pendientes por entregarnos. </b> </p>'+
  //       '<p style="font-size:20px"> Por favor comuniquese con su asesor de confianza.</p>' ,
  //       customClass: {
  //           html: 'custom-button',
  //       },
  //     })
